...
* Enable setting multiple compile commands. [#7029](https://github.com/microsoft/vscode-cpptools/issues/7029)
  * Thank you for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#12960](https://github.com/Microsoft/vscode-cpptools/issues/12960)](https://github.com/microsoft/vscode-cpptools/pull/12960)
...
* Add support for providing well-known compiler argument information to Copilot Completions. [PR [#12979](https://github.com/Microsoft/vscode-cpptools/issues/12979)](https://github.com/microsoft/vscode-cpptools/pull/12979)
* Fixed unnecessary cancellation of Copilot context requests. [PR [#12988](https://github.com/Microsoft/vscode-cpptools/issues/12988)](https://github.com/microsoft/vscode-cpptools/pull/12988)
* Add support for passing an additional parameter to `C_Cpp.ConfigurationSelect` command. [PR [#12993](https://github.com/Microsoft/vscode-cpptools/issues/12993)](https://github.com/microsoft/vscode-cpptools/pull/12993)
  * Thank you for the contribution. [@adrianstephens](https://github.com/adrianstephens)
* Update clang path setting descriptions. [PR [#13071](https://github.com/Microsoft/vscode-cpptools/issues/13071)](https://github.com/microsoft/vscode-cpptools/pull/13071)
...
* Fix `compile_commands.json` no longer being used if the containing folder is deleted and recreated. [#7030](https://github.com/microsoft/vscode-cpptools/issues/7030)
  * Thank you for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#13032](https://github.com/Microsoft/vscode-cpptools/issues/13032)](https://github.com/microsoft/vscode-cpptools/pull/13032)
...
* Fix a leak of compile command file watchers. [#12946](https://github.com/microsoft/vscode-cpptools/issues/12946)
  * Thank you for the contribution. [@yiftahw](https://github.com/yiftahw) [PR [#12948](https://github.com/Microsoft/vscode-cpptools/issues/12948)](https://github.com/microsoft/vscode-cpptools/pull/12948)
...
* Fix a couple bugs with `.editorConfig` handling. [PR [#13140](https://github.com/Microsoft/vscode-cpptools/issues/13140)](https://github.com/microsoft/vscode-cpptools/pull/13140)
...
* Enable `#cpp` with GitHub Copilot chat without `C_Cpp.experimentalFeatures` enabled. [PR [#12898](https://github.com/Microsoft/vscode-cpptools/issues/12898)](https://github.com/microsoft/vscode-cpptools/pull/12898)
...
* Fix stale colorization due to delays in updating the open file version. [PR [#12851](https://github.com/Microsoft/vscode-cpptools/issues/12851)](https://github.com/microsoft/vscode-cpptools/pull/12851)
* Fix redundant progressive squiggle updates. [PR [#12876](https://github.com/Microsoft/vscode-cpptools/issues/12876)](https://github.com/microsoft/vscode-cpptools/pull/12876)
...
* Add "Additional Tracked Settings" to the `C/C++: Log Diagnostics` output. [PR [#12635](https://github.com/Microsoft/vscode-cpptools/issues/12635)](https://github.com/microsoft/vscode-cpptools/pull/12635)
* Add support for providing additional context information to Copilot Chat. [PR [#12685](https://github.com/Microsoft/vscode-cpptools/issues/12685)](https://github.com/microsoft/vscode-cpptools/pull/12685)
...
* Fix an issue preventing use of a full command line in `compilerPath`. [PR [#12774](https://github.com/Microsoft/vscode-cpptools/issues/12774)](https://github.com/microsoft/vscode-cpptools/pull/12774)
...
* Update the vcpkg header database. [PR [#12430](https://github.com/Microsoft/vscode-cpptools/issues/12430)](https://github.com/microsoft/vscode-cpptools/pull/12430)
...
* Fix custom configurations sometimes not getting used. [PR [#12427](https://github.com/Microsoft/vscode-cpptools/issues/12427)](https://github.com/microsoft/vscode-cpptools/pull/12427)
* Fix a code analysis error when using gcc 14. [#12428](https://github.com/microsoft/vscode-cpptools/issues/12428)
* Fix warning notification showing when `C_Cpp.getIncludes` is disabled. [PR [#12470](https://github.com/Microsoft/vscode-cpptools/issues/12470)](https://github.com/microsoft/vscode-cpptools/pull/12470)
...
* Reduce the default max workspace symbol search results and add `C_Cpp.maxSymbolSearchResults`. [PR [#12131](https://github.com/Microsoft/vscode-cpptools/issues/12131)](https://github.com/microsoft/vscode-cpptools/pull/12131)
* Update `clang-format`/`clang-tidy` to 18.1.2. [PR [#12135](https://github.com/Microsoft/vscode-cpptools/issues/12135)](https://github.com/microsoft/vscode-cpptools/pull/12135)
...
* Fix `forcedInclude` resolution for relative paths. [PR [#12035](https://github.com/Microsoft/vscode-cpptools/issues/12035)](https://github.com/microsoft/vscode-cpptools/pull/12035)
...
* Change the default setting value for `C_Cpp.intelliSenseUpdateDelay` from 2s to 1s. [PR [#11932](https://github.com/Microsoft/vscode-cpptools/issues/11932)](https://github.com/microsoft/vscode-cpptools/pull/11932)
...
* Fix the default `editor.wordBasedSuggestions` setting for VS Code versions 1.85 or newer. [PR [#11773](https://github.com/Microsoft/vscode-cpptools/issues/11773)](https://github.com/microsoft/vscode-cpptools/pull/11773)
...
* Fix German code analysis translations. [PR [#11845](https://github.com/Microsoft/vscode-cpptools/issues/11845)](https://github.com/microsoft/vscode-cpptools/pull/11845)
...
* Update clang-format and clang-tidy to 17. [PR [#11491](https://github.com/Microsoft/vscode-cpptools/issues/11491)](https://github.com/microsoft/vscode-cpptools/pull/11491)
* Add a pre-release available notification. [PR [#11569](https://github.com/Microsoft/vscode-cpptools/issues/11569)](https://github.com/microsoft/vscode-cpptools/pull/11569)
...
* Fix an issue with the compiler currently configured for use with IntelliSense being listed last in the task creation popup. [PR [#11299](https://github.com/Microsoft/vscode-cpptools/issues/11299)](https://github.com/microsoft/vscode-cpptools/pull/11299)
...
* [@michalmaka (Michał Mąka)](https://github.com/michalmaka): Add support for Toybox to the remote process picker. [PR [#11175](https://github.com/Microsoft/vscode-cpptools/issues/11175)](https://github.com/microsoft/vscode-cpptools/pull/11175)
...
* [@yne (Rémy F.)](https://github.com/yne): Add wildcard support for `includePath`. [PR [#10388](https://github.com/Microsoft/vscode-cpptools/issues/10388)](https://github.com/microsoft/vscode-cpptools/pull/10388)
...
* Add `miDebuggerArgs` to debugger attach option.
  * Thank you for the contribution @Summon528 [PR [#11066](https://github.com/Microsoft/vscode-cpptools/issues/11066)](https://github.com/microsoft/vscode-cpptools/pull/11066)
...
* Fix a bug with workspace parsing status. [PR [#10974](https://github.com/Microsoft/vscode-cpptools/issues/10974)](https://github.com/microsoft/vscode-cpptools/pull/10974)
...
* Stop using vcFormat if .editorconfig exists with only non-formatting cpp settings. [PR [#11015](https://github.com/Microsoft/vscode-cpptools/issues/11015)](https://github.com/microsoft/vscode-cpptools/pull/11015)
* Use integratedTerminal when user is running cl.exe for debugger. [#11032](https://github.com/microsoft/vscode-cpptools/issues/11032)
  * Thank you for the contribution @caiohamamura [PR [#11035](https://github.com/Microsoft/vscode-cpptools/issues/11035)](https://github.com/microsoft/vscode-cpptools/pull/11035)
...
* Re-enable an updated C/C++ walkthrough (currently only available for some users). [PR [#10707](https://github.com/Microsoft/vscode-cpptools/issues/10707)](https://github.com/microsoft/vscode-cpptools/pull/10707)
...
* Fix random failures when adding or removing workspace folders. [PR [#10665](https://github.com/Microsoft/vscode-cpptools/issues/10665)](https://github.com/microsoft/vscode-cpptools/pull/10665)
...
* For remote attach, use an absolute `/bin/sh` path on Linux. [PR [#10765](https://github.com/Microsoft/vscode-cpptools/issues/10765)](https://github.com/microsoft/vscode-cpptools/pull/10765)
* Fix the first registered configuration provider still being automatically used after a second registers. [PR [#10772](https://github.com/Microsoft/vscode-cpptools/issues/10772)](https://github.com/microsoft/vscode-cpptools/pull/10772)
...
* Fix some issues due to usage of the spread operator not doing a deep copy. [PR [#10803](https://github.com/Microsoft/vscode-cpptools/issues/10803)](https://github.com/microsoft/vscode-cpptools/pull/10803)
...
* Fix the C/C++-related status bar items flickering off/on when switching documents. [PR [#10888](https://github.com/Microsoft/vscode-cpptools/issues/10888)](https://github.com/microsoft/vscode-cpptools/pull/10888)
...
* Auto-configure `configurationProvider` even if `default.compilerPath` is set. [PR [#10607](https://github.com/Microsoft/vscode-cpptools/issues/10607)](https://github.com/microsoft/vscode-cpptools/pull/10607)
...
* Fix the configuration provider browse cache not getting cleared. [PR [#10608](https://github.com/Microsoft/vscode-cpptools/issues/10608)](https://github.com/microsoft/vscode-cpptools/pull/10608)
...
* Fix a bug with settings changes not being handled correctly for multi-root. [PR [#10458](https://github.com/Microsoft/vscode-cpptools/issues/10458)](https://github.com/microsoft/vscode-cpptools/pull/10458)
...
* Fix "Configure Task" selection to show root folder names for multi-root workspace [PR [#7315](https://github.com/Microsoft/vscode-cpptools/issues/7315)](https://github.com/microsoft/vscode-cpptools/pull/7315)
